...
const AdminJobsTable = () => {
  ...
  // Helper function to render applicant count badge
  const renderApplicantBadge = (count) => {
    if (count === 0) {
      return (
        <div className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-gray-500 bg-gray-100 rounded-full">
    ...
    if (count <= 15) {
      return (
        <div className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-orange-700 bg-orange-100 rounded-full">
          <Users className="w-3 h-3" />
          <span>{count}</span>
        </div>
      );
    ...
    return (
      <div className="inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-green-700 bg-green-100 rounded-full">
        <Users className="w-3 h-3" />
        <span>{count}</span>
      </div>
    );
          ...
          {allAdminJobs.length === 0 ? (
            ...
            filterJobs.map((job) => (
              ...
              >
                ...
                <TableCell className="py-4 px-6">
                  {renderApplicantBadge(job?.applicantCount || 0)}
                </TableCell>
                    ...
                    <PopoverContent className="w-44 p-2 shadow-lg border border-gray-200">
                      ...
                      >
                        ...
                        <span className="font-medium">
                          View Applicants{" "}
                          {job?.applicantCount > 0 && `(${job.applicantCount})`}
                        </span>
                      </div>
